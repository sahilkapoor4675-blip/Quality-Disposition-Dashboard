...
- **Intro screen background:** the plain white background now has copper-base watermark artwork: two large slowly rotating copper coil faces with a metallic glint, a faint "Cu 29" mark, flowing ribbon waves along the bottom and a copper glow, fading in as the intro starts. It sits behind a soft white veil, so intro text stays clear.
