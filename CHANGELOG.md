...
## V65.0 — Follow-up: structured logging, multi-instance session/login sync, streaming CSV export, dead-CSS cleanup, dependency-vulnerability CI (no version bump — same version)
